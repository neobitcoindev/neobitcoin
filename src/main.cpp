...
// Copyright (c) 2018-2019 The NeoBitcoin developers
...
#if defined(NDEBUG)
#error "NeoBitcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in unbtc) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    int64_t nSubsidy = 0;
     ...
     } else if (nHeight == 1)                          { nSubsidy = 15000000 * COIN; //premimed
     } else if (nHeight > 1 && nHeight <= 200)       { nSubsidy = 2500 * COIN;
     } else if (nHeight > 200 && nHeight <= 100000)  { nSubsidy = 13 * COIN;
     } else if (nHeight > 100000 && nHeight <= 150000) { nSubsidy = 14 * COIN;
     } else if (nHeight > 150000 && nHeight <= 200000) { nSubsidy = 15 * COIN;
     } else if (nHeight > 200000 && nHeight <= 250000) { nSubsidy = 16 * COIN;
     } else if (nHeight > 250000 && nHeight <= 300000) { nSubsidy = 17 * COIN;
     } else if (nHeight > 300000 && nHeight <= 350000) { nSubsidy = 18 * COIN;
     } else if (nHeight > 350000 && nHeight <= 400000) { nSubsidy = 19 * COIN;
     } else if (nHeight > 400000 && nHeight <= 450000) { nSubsidy = 20 * COIN;
     } else if (nHeight > 450000 && nHeight <= 500000) { nSubsidy = 21 * COIN;
     } else if (nHeight > 500000 && nHeight <= 550000) { nSubsidy = 22 * COIN;
     } else if (nHeight > 550000 && nHeight <= 600000) { nSubsidy = 23 * COIN;
     } else if (nHeight > 600000 && nHeight <= 650000) { nSubsidy = 24 * COIN;
     } else if (nHeight > 650000 && nHeight <= 700000) { nSubsidy = 25 * COIN;
     } else if (nHeight > 700000 && nHeight <= 750000) { nSubsidy = 26 * COIN;
     } else if (nHeight > 750000 && nHeight <= 800000) { nSubsidy = 27 * COIN;
     } else if (nHeight > 800000 && nHeight <= 850000) { nSubsidy = 28 * COIN;
     } else if (nHeight > 850000 && nHeight <= 900000) { nSubsidy = 29 * COIN;
     } else if (nHeight > 900000 && nHeight <= 950000) { nSubsidy = 30 * COIN;
    } else if (nHeight > 950000) { nSubsidy = 10 * COIN; }
...
CAmount GetMasternodeCollateral()
{
    if( chainActive.Height() >= 450000 )
        return MASTERNODE_COLLATERAL_AFTER_450000;
...
{
    RenameThread("neobitcoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // NBTC: We use certain sporks during IBD, so check to see if they are
...
int ActiveProtocol()
{
    if (IsSporkActive(SPORK_23_NEW_PROTOCOL_ENFORCEMENT_9))
        return MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT_9;

    if (IsSporkActive(SPORK_22_NEW_PROTOCOL_ENFORCEMENT_8))
        return MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT_8;

    if (IsSporkActive(SPORK_21_NEW_PROTOCOL_ENFORCEMENT_7))
        return MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT_7;
